...
import {
  ...
  transitionSpecialistAction,
  type SpecialistMutated,
} from "@/app/admin/(painel)/especialistas/actions";
import { Button, FormMessage } from "@/components/ui";
import type { ActionResult } from "@/lib/result";
import type { SpecialistStatus } from "@/features/people/application/specialist-service";
...
const TRANSITION_LABEL: Record<SpecialistStatus, string> = {
...
type Props = {
  ...
  version: number;
  targets: SpecialistStatus[];
  canDelete: boolean;
};

export function SpecialistStatusPanel({
  specialistId,
  status,
  version,
  targets,
  ...
  >(async (prevState, formData) => {
    const result = await transitionSpecialistAction(prevState, formData);
