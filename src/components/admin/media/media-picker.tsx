...
/** Verdadeiro só depois de montar no navegador, sem `setState` num efeito (o servidor nunca tem
 * `document`, e o portal não deve existir antes da hidratação). */
 ...
 *
 * O editor (e este seletor) sempre acaba dentro do `<form>` do artigo/página que o usa. Um
 * `<form>` não pode conter outro `<form>` (o de envio de imagem, aqui dentro): HTML inválido faz
 * o navegador descartar a aninhada, e o React nem hidrata direito. Por isso o `<dialog>` é
 * renderizado num portal para `document.body`, fora da árvore do formulário externo.
 */
